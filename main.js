...
export default class Scene {
  ...
  project(x) {
    return new Vector2(this.canvas.width/2+((x.x+this.cam.x)*this.fov)/((x.z+this.cam.z)+this.fov), this.canvas.height/2-((x.y+this.cam.y)*this.fov)/((x.z+this.cam.z)+this.fov));
  }
  polygon(x, y, z) {
