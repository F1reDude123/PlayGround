...
export default class Scene {
  ...
  plane(t){
    this.polygon(new Vector3(-t.pivot.x, 0, -t.pivot.z).rotateX(t.rot.x).rotateY(t.rot.y).rotateZ(t.rot.z).add(t.pos), new Vector3(t.pivot.x, 0, -t.pivot.z).rotateX(t.rot.x).rotateY(t.rot.y).rotateZ(t.rot.z).add(t.pos), new Vector3(-t.pivot.x, 0, t.pivot.z).rotateX(t.rot.x).rotateY(t.rot.y).rotateZ(t.rot.z).add(t.pos));    
    this.polygon(new Vector3(t.pivot.x, 0, -t.pivot.z).rotateX(t.rot.x).rotateY(t.rot.y).rotateZ(t.rot.z).add(t.pos), new Vector3(-t.pivot.x, 0, t.pivot.z).rotateX(t.rot.x).rotateY(t.rot.y).rotateZ(t.rot.z).add(t.pos), new Vector3(t.pivot.x, 0, t.pivot.z).rotateX(t.rot.x).rotateY(t.rot.y).rotateZ(t.rot.z).add(t.pos));
  }
  degToRad(x) {
